...
const PaymentForm = ({ open, onClose, refreshTransactions }: PaymentFormProps) => {
  ...
  const handleSubmit = async (event) => {
    ...
    const newTransaction = {
      transactor: user?.id, // Set the transactor as the logged-in user's Clerk ID
      transactee,
    ...
    try {
      const result = await createTransaction({
        ...newTransaction,
        id: -1, // ID should be generated by the backend
        groupId: 1, // how to set this?
        type: 'income', // or 'income'
        status: 'pending', // a new transaction starts as 'pending'
        notes: '', // no notes to start with
      });
